            ...
            <div class="row">
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
          		<form action="<?=base_url()?>scartchcard/insert" role="form" id="userForm" name="userForm" method="post" enctype="multipart/form-data">
          			<div class="form-row">
          				<div class="col-md-4">
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="orange_desc" id="editor1" class="form-control" placeholder="Enter Orange Description"></textarea><?php echo form_error('orange_desc'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="yellow_desc" id="editor1" class="form-control" placeholder="Enter Yellow Description"></textarea><?php echo form_error('yellow_desc'); ?>
                    </div>
                  </div>
                  ...
                  <div class="col-md-12">
                    <div class="form-group">
                      ...
                      <textarea name="blue_desc" id="editor1" class="form-control" placeholder="Enter Blue Description"></textarea><?php echo form_error('blue_desc'); ?>
                    </div>
                  </div>
